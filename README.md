...
### [ORAND Praxis — conversation branching](https://github.com/Dragos-cloud/conversation_branching)
...
### [CV–JD evaluator](https://github.com/Dragos-cloud/local_jd_cv_evaluator)
Match your CV against a job description locally. Skills gap identification, fit score, CV optimisation advice, corporate jargon translation. No cloud, no API keys.
`HTML` · `MIT`
